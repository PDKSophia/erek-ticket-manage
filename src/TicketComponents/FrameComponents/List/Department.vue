        ...
        <div class="erek-list-item">
          <div class="ant-list-item-content-single">
              ...
              <div class="erek-card-meta">
                ...
                <div class="erek-card-meta-detail">
                  <div class="erek-card-meta-title">
                    <a>{{ item.depart_name }}</a>
                  </div>
                  <div class="erek-card-meta-description">
                    <div class="erek-card-ellipsis">{{ item.depart_content }}</div>
                  </div>
                </div>
              </div>
            </div>
            <ul class="erek-card-actions">
              <li>
                <span @click="onHandleActions('view', item)">查看</span>
              </li>
              <li>
                <span @click="onHandleActions('update', item)">编辑</span>
              </li>
              <li>
                <span @click="onHandleActions('delete', item)">删除</span>
              </li>
            </ul>
          </div>
        </div>
