...
export default {
  ...
  data() {
    return {
      ...
      ruleValidate: {
        username: [{ required: true, message: '名字不能为空', tigger: 'blur' }],
        email: [
          { required: true, message: '邮箱不能为空', tigger: 'blur' },
          { type: 'email', message: '邮箱格式不正确', tigger: 'blur' }
        ],
        city: [{ required: true, message: '城市不能为空', tigger: 'change' }],
        gender: [{ required: true, message: '性别不能为空', tigger: 'change' }],
        tag: [
          {
            required: true,
            type: 'array',
        ...
        address: [{ required: true, message: '地址不能为空', tigger: 'blur' }],
        desc: [
